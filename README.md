...
- 2019 - [**DIABLO**](https://github.com/singha53-zz/diablo) - Singh - Multi-block Sparse PLS-Discriminant Analysis - [DIABLO: an integrative approach for identifying key molecular drivers from multi-omics assays](https://doi.org/10.1093/bioinformatics/bty1054)
  - Does not directly handle repeated measures, but can after some [preprocessing](https://mixomics-users.discourse.group/t/appropriate-mixomics-methodology-for-multi-omics-integration-with-time-course-measurements/1175/4).
...
- 2023 - Hu & Szymczak - [A review on longitudinal data analysis with random forest](https://doi.org/10.1093/bib/bbad002)
